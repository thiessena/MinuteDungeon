...
public class Countdown implements NetObject {
    ...
    public String umrechnen() {
        if (inPause == true) {
            restlicheZeit = (startzeit + laenge + System.currentTimeMillis() - pausenStart)
    ...
    public String toNetString() {
        return startzeit + NetTrennzeichen.TIMER_TRENNZEICHEN + pause + NetTrennzeichen.TIMER_TRENNZEICHEN + pausenStart
                + NetTrennzeichen.TIMER_TRENNZEICHEN + inPause + NetTrennzeichen.TIMER_TRENNZEICHEN + laenge
                + NetTrennzeichen.TIMER_TRENNZEICHEN + restlicheZeit + NetTrennzeichen.TIMER_TRENNZEICHEN;
